...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-plus"></i> Criar Rotina</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Início</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Criar Rotina</li>
                        </ol>
                    </nav>
                        ...
                        <div class="col-md-5 mb-4">
                            <div class="p-3 border bg-light shadow-sm">
                                <form action="{{route('section.routine.store')}}" method="POST">
                                    ...
                                    <div>
                                        <p class="mt-2">Selecione a turma:<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                    ...
                                    <div>
                                        <p class="mt-2">Selecione a seção:<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
