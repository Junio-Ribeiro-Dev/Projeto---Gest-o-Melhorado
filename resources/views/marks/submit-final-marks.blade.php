        ...
        <div class="col-12 col-lg-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    ...
                    <h5><i class="bi bi-diagrama-2"></i> Turma {{$class_name}}, Seção #{{$section_name}}</h5>
                    <h5><i class="bi bi-compass"></i> Curso: {{$course_name}}</h5>
                                        ...
                                        <tbody>
                                            @isset($students_with_marks)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea class="form-control" rows="1" name="note[{{$students_with_mark[0]->student->id}}]" placeholder="Contabiliza as 2 melhores provas de 3,..."></textarea></td>
                                                </tr>
                                                @endforeach
                                            @endisset
