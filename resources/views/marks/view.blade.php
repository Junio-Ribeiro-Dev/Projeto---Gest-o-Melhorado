            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-cloud-sun"></i> Visualizar Notas
                    </h1>
                    <h5><i class="bi bi-diagram-2"></i> Turma 1, Seção #1 </h5>
                    <h5><i class="bi bi-compass"></i> Curso: Matemática </h5>
                    <div class="row mt-3">
                        <div class="col">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Quiz 1</th>
                                            <th scope="col">Quiz 2</th>
                                            <th scope="col">Prova Parcial</th>
                                            <th scope="col">Quiz 3</th>
                                            <th scope="col">Quiz 4</th>
                                            <th scope="col">Trabalho 1</th>
                                            <th scope="col">Trabalho 2</th>
