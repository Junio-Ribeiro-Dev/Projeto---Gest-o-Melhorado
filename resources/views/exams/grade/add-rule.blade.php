...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-file-plus"></i> Adicionar regra de avaliação</h1>
                        ...
                        <div class="col-5 mb-4">
                            <div class="p-3 border bg-light">
                                <form action="{{route('exam.grade.system.rule.store')}}" method="POST">
                                    ...
                                    <div class="mt-2">
                                        <label for="inputPoint" class="form-label">Apontar<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                    ...
                                    <div class="mt-2">
                                        <label for="inputStarts" class="form-label">Começo<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
