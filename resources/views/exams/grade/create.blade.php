...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-file-plus"></i> Criar Sistema de Notas</h1>
                        ...
                        <div class="col-md-5 mb-4">
                            <div class="p-3 border shadow-sm bg-light">
                                <form action="{{route('exam.grade.system.store')}}" method="POST">
                                    ...
                                    <div>
                                        <p class="mt-2">Selecionar semestre:<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                    ...
                                    <div class="mt-2">
                                        <p>Nome do Sistema de Notas<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                        <input type="text" class="form-control" placeholder="Sistema de Notas 1" aria-label="Sistema de Notas 1" name="system_name" required>
                                    </div>
