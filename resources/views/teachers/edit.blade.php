                    ...
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.teacher.update')}}" method="POST">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" name="first_name" placeholder="Nome" required value="{{$teacher->first_name}}">
                            </div>
                            <div class="col-3">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control" id="inputAddress" name="address" placeholder="Rua Principal, 634" required value="{{$teacher->address}}">
                            </div>
                            <div class="col-3">
                                <label for="inputAddress2" class="form-label">Complemento</label>
                                <input type="text" class="form-control" id="inputAddress2" name="address2" placeholder="Apartamento, sala, andar" value="{{$teacher->address2}}">
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="inputPhone" name="phone" placeholder="+55 00 00000-0000" required value="{{$teacher->phone}}">
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="inputNationality" name="nationality" placeholder="Ex: Brasileiro, Alemão, ..." required value="{{$teacher->nationality}}">
                            </div>
                            <div class="col-12">
