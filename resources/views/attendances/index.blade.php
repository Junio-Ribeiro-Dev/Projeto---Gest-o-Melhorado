...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-calendar2-week"></i> Chamada</h1>
                    <div class="row">
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="card my-3">
                                                ...
                                                @foreach ($courses as $course)
                                                    ...
                                                    <div class="list-group mb-2">
                                                        <a href="{{url('attendances/view?class_id='.$school_class->id.'&class_name='.$school_class->class_name.'&course_id='.$course->id.'&course_name='.$course->course_name)}}" class="list-group-item list-group-item-action  d-flex justify-content-between align-items-center">
                                                            Ver Chamada
                                                            {{-- <span class="badge bg-success rounded-pill">PRESENTE HOJE</span> --}}
                                                        </a>
                                        ...
                                        {{-- <div class="card-footer bg-transparent">Total de Estudantes:</div> --}}
                                    </div>
                                </div>
                                @endforeach
                            </div>
