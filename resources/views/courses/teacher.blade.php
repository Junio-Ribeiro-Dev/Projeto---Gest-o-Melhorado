                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-calendar2-week me-2"></i> Marque Presença</a></li>
                                                    ...
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-file-post me-2"></i> 
Criar tarefa</a></li>
                                                    ...
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-input-cursor me-2"></i> Dê notas</a></li>
                                                    <li><a href="{{route('course.mark.list.show', [
                                                        ...
                                                        'course_name' => $course->course->course_name,
                                                        'semester_id' => $selected_semester_id
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-cloud-sun me-2"></i> Ver resultados finais
</a></li>
                                                    <li><a href="#" role="button" class="dropdown-item disabled"  tabindex="-1" aria-disabled="true"><i class="bi bi-chat-left-text me-2"></i> Mensagem aos alunos</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
